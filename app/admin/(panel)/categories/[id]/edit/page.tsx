  ...
  return (
    <div className="max-w-2xl space-y-6 p-6">
      ...
      <nav className="flex items-center gap-1.5 text-xs text-muted-foreground">
        ...
        <span className="font-bold text-foreground">Edit: {category.name}</span>
      </nav>

      <div>
        <h1 className="text-2xl font-black uppercase tracking-tight">Edit Kategori</h1>
        <p className="mt-0.5 text-sm text-muted-foreground">Perbarui data kategori.</p>
      </div>
