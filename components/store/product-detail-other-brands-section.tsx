  ...
  return (
    <section className="border-t border-[#e0e0e0] bg-white py-14 md:py-16" aria-labelledby="other-brands-heading">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        <h2 id="other-brands-heading" className="mb-10 text-[clamp(1.25rem,3vw,1.5rem)] font-semibold tracking-tight text-[#1d1d1f]">
          Produk lainnya di brand lain
        </h2>

        {groups.map((group) => (
          <div key={group.categorySlug} className="mb-14 last:mb-0">
            <h3 className="mb-5 text-xs font-semibold uppercase tracking-[0.2em] text-[#7a7a7a]">{group.categoryName}</h3>
